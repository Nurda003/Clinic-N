    ...
    <div className='px-20 py-10'>
        ...
        <div className="">
            <div className="bg-part h-500 bg-no-repeat bg-cover mt-10 -mx-20 flex justify-center items-start flex-col gap-10">
                ...
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 rounded-3xl px-7 ml-10%'>Start</button>
            </div>
            ...
            <div className="flex flex-col justify-center items-center">
                ...
                <div className=' w-5/6 flex gap-2 items-start justify-center px-4 py-5 mt-10'>

                    <div className="p-8">
                        <a href="#" className="block max-w-sm p-6 bg-card rounded-lg shadow hover:bg-gray-100 ">
                        <img src={first} alt="" />
            ...
            <div className="bg-slate-900 h-500 flex justify-center items-center gap-10 -mx-20 ">
                <div className="flex flex-col justify-center gap-5 text-white">
                    <h1 className='font-semibold text-5xl w-3/5'>Leave a Request For Becoming Partner</h1>
                ...
                <div className="flex justify-center w-1/4 items-center">
                    <form className="flex items-center justify-center flex-col p-14 w-full bg-white gap-6 rounded-xl">
                        <p className='text-center font-semibold text-2xl w-full mb-5'>Request Partnership</p>
                        <input type="text" className='text-bigtext sm:text-sm rounded-lg block w-full p-2.5 placeholder-gray-500 border-2 border-gray-300' placeholder='Full Name' />
                        <input type="text" className='text-bigtext sm:text-sm rounded-lg block w-full p-2.5 placeholder-gray-500 border-2 border-gray-300' placeholder='Phone Number' />
                        <input type="email" className='text-bigtext sm:text-sm rounded-lg block w-full p-2.5 placeholder-gray-500 border-2 border-gray-300' placeholder='Email Address' />
                        <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 rounded-xl px-7' type='submit'>Submit</button>
                    </form>
                </div>
            </div>
            ...
            <div className="mt-20 w-full flex justify-center">
                ...
                <ol className="relative border-s border-gray-200 flex flex-col justify-center w-2/5">                  
                    ...
                    <li className="mb-10 ms-6 w-full">            
                        ...
                        <p className="mb-4 text-xl font-normal w-full text-gray-500 ">Once registered, access your clinic dashboard to customize your profile. Add detailed information about your clinic, including specialties, dentist profiles, opening hours, and high-quality images.</p>
                    ...
                    <li className="mb-10 ms-6 w-full">            
                        ...
                        <h3 className="flex items-center mb-3 text- font-semibold text-gray-900 ">Manage Appointments<span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded ms-3">Third</span></h3>
                        <p className="mb-4 text-xl font-normal w-full text-gray-500 ">Sit lectus parturient diam ac congue elementum praesent blandit. Tristique ut ut venenatis tortor, id elementum. Integer tristique viverra enim libero.</p>
                    ...
                    <li className="mb-10 ms-6 w-full">            
                        ...
                        <h3 className="flex items-center mb-3 text- font-semibold text-gray-900 ">Manage Appointments<span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded ms-3">Fourth</span></h3>
                        <p className="mb-4 text-xl font-normal w-full text-gray-500 ">Receive appointment requests from patients, which you can either confirm or reschedule through the dashboard.</p>
                    ...
                    <li className="ms-6">            
                        ...
                        <p className="mb-4 text-xl font-normal w-full text-gray-500 ">Now you ready to receive patients.Good luck!</p>
