    ...
    <div className='flex items-center justify-around p-5'>
        <div className="flex flex-col">
            ...
            <div className="w-1/2 mb-10">
                ...
                Discover the ease of finding the right dental care for you and your family. Your gateway to hassle-free dental bookings online
                </p>
            </div>
            <div className="mb-10">
                <button className='bg-blue-500 hover:bg-blue-700 text-white font-bold py-4 rounded-lg px-7'><Link to='/Clinics'>Book an appointment</Link></button>
            </div>
            <div className="w-96">
